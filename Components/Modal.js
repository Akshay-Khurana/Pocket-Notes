...
const Modal = ({ onClose, isMobile }) => {
  ...
  return (
    <div
      ...
      style={
        isMobile
          ? { width: "42%", height: "30%", left: "10vw", top: "36vh" }
          : {}
      }
      ref={modalRef}
    >
      <div className="modal-content" style={isMobile ? { width: "254px" } : {}}>
        ...
        <div className="part-3">
          ...
          <div
            ...
            className="purple colors "
          ></div>
          <div
            onClick={() => changecolor("pink")}
            className="pink colors"
          ></div>
          <div
            onClick={() => changecolor("sky-blue")}
            className="sky-blue colors "
          ></div>
          <div
            onClick={() => changecolor("orange")}
            className="orange colors"
          ></div>
          <div
            onClick={() => changecolor("blue")}
            className="blue colors"
          ></div>
          <div
            onClick={() => changecolor("purple-blue")}
            className="purple-blue colors"
          ></div>
        </div>
