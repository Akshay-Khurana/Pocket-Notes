...
import Logo from "../assets/bg-notes-app.png"

const RightPanel = () =>{
    return (
        <div className="right-container">
            <img src = {Logo} className="flex-items"/>
            <h2 className="flex-items">Pocket Notes </h2>
            <p className="flex-items"> Send and receive messages without keeping your phone online.<br/>Use Pocket Notes on up to 4 linked devices and 1 mobile phone</p>
            <div className="last-msg flex-items">
...
<p className="bottom-msg"> end-to-end encrypted </p>
</div>
